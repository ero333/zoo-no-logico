...
// public class FusionCraft : MonoBehaviour
// {
...
//             }
//             if((s1 == database.Cocodrilo)||(s2 == database.Carpincho)||(s3 == database.Murcielago))
//             {
//                 fused = true;
//                 fusion;//= imagen de resultado//
//             }
//             if((s1 == database.Murcielago)||(s2 == database.Carpincho)||(s3 == database.Cocodrilo))
//             {
//                 fused = true;
//                 fusion;//= imagen de resultado//
//             }
...
//                 fusion;//= imagen de resultado//
//             }
//             if((s1 == database.Carpincho)||(s2 == database.Murcielago)||(s3 == database.Cocodrilo))
//             {
//                 fused = true;
//                 fusion;//= imagen de resultado//
//             }
